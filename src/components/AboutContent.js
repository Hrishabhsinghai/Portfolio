  ...
  return (
    <div className="about">
      ...
      <div className="left">
        <h1> Who Am I ? </h1>{" "}
        <p className="pp">
          I am a well - organized, creative and goal - oriented graduate and a
          Front - end developer posessing excellent problem - solving skills, I
          create responsive and secure websites with efficency and precision.{" "}
        </p>{" "}
        <Link to="/contact">
